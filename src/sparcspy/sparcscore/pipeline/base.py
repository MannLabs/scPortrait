...
class ProcessingStep(Logable):
    ...
    def __call__(self, *args, debug=None, intermediate_output=None, overwrite=None, **kwargs):
    ...
    def __call_empty__(self, *args, debug=None, intermediate_output=None, overwrite=None, **kwargs):
