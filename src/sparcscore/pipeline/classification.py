...
class MLClusterClassifier:
    ...
    def __init__(self, 
        ...
        Args:
            config (dict): Configuration for the extraction passed over from the :class:`pipeline.Project`.
            path (str): Directory for the extraction log and results. Will be created if not existing yet.
            debug (bool, optional, default=False): Flag used to output debug information and map images.
            overwrite (bool, optional, default=False): Flag used to overwrite existing results.
        """
